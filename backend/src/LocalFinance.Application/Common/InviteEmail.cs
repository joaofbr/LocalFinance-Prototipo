...
public static class InviteEmail
{
    public static EmailMessage Build(string name, string toEmail, string link, int expiryHours)
    {
        ...
        const string subject = "Seu acesso ao LocalFinance";

        var text =
            $"""
            Olá, {firstName}!

            Você foi adicionado ao LocalFinance, o controle financeiro da família.
                  ...
                  <tr><td align="center">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                      ...
                      <tr><td style="font-size:15px;line-height:1.6;padding-bottom:24px">
                        Você foi adicionado ao controle financeiro da família.
                        Para acessar, defina sua senha:
                      </td></tr>
